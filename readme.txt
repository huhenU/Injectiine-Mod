...
Step 4: Open the Injectiine file and follow the instructions
	...
	In case you are trying to inject a game, but no base is good for it, you can use a custom base:
		...
		-Put the code,content,meta folders into a folder named "Base"
		-Put the "Base" folder into the Files directory

	If you are doing a N64 Inject, but can't get it to work, a custom config.ini can help.
		-Just put a custom config.ini into the Files directory

== OPTIONAL IMAGE FILES ==
-bootDrcTex.png [854 x 480]
-bootLogoTex.png [170 x 42]
-drcback.png (854 x 480) [NDS only]
-nds1st_31p.png (854 x 480) [NDS only]
-nds1st_31p_tv.png (1280 x 720) [NDS only]
-tvback.png (1280 x 720) [NDS only]
