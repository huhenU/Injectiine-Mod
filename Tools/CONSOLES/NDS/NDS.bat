...
echo ::::::::::::::::::::::::::
echo ::INJECTIINE [NDS] - Mod::
echo ::::::::::::::::::::::::::

:: CHECK THAT FILES EXIST

IF NOT EXIST *.nds GOTO:LastChance
IF NOT EXIST bootTvTex.png GOTO:NoImage
IF NOT EXIST iconTex.png GOTO:NoImage
...
echo.
echo Brain Age [USA] [20.75 MB]               (1)
echo Brain Training [EUR] [23.99 MB]          (2)
echo Kirby Squeak Squad [USA] [29.35 MB]      (3)
echo Kirby Mouse Attack [EUR] [34.24 MB]      (4)
echo New Super Mario Bros. [USA] [29.95 MB]   (5) 
...
:RestOfParameters
echo Enter a 4-digit product code. This can be anything
...
cd ..
cd Files
IF EXIST iconTex.png (xcopy iconTex.png ../Tools/png2tga)
IF NOT EXIST bootDrcTex.png (copy bootTvTex.png bootDrcTex.png)
IF EXIST bootTvTex.png (xcopy /ybootTvTex.png ../Tools/png2tga)
IF EXIST bootDrcTex.png (xcopy /y bootDrcTex.png ../Tools/png2tga)
IF EXIST bootLogoTex.png (xcopy /y bootLogoTex.png ../Tools/png2tga)
IF EXIST drcback.png (xcopy /y drcback.png ../Tools/CONSOLES/NDS/WORKDIR/content/0010/assets/textures/drcback.png)
IF EXIST tvback.png (xcopy /y tvback.png ../Tools/CONSOLES/NDS/WORKDIR/content/0010/assets/textures/tvback.png)
IF EXIST nds1st_31p.png (xcopy /y nds1st_31p.png ../Tools/CONSOLES/NDS/WORKDIR/content/0010/assets/textures/nds1st_31p.png)
IF EXIST nds1st_31p_tv.png (xcopy /y nds1st_31p_tv.png ../Tools/CONSOLES/NDS/WORKDIR/content/0010/assets/textures/nds1st_31p_tv.png)
...
cd ../CONSOLES/NDS
cd ..
xcopy /y NDS\WORKDIR ..\..\Output\"[NDS] %GAMENAME% [%PRODUCTCODE%]"
